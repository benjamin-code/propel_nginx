...
if node.chef_environment == 'prod'
	...
	default[:propel_nginx][:propel_applayer_vip] = "atcswa-cr-atlassian.ecs-core.ssn.hp.com"
...
if node.chef_environment == 'sandbox'
	...
	default[:propel_nginx][:propel_applayer_vip] = "nginxvip.hp.com"
...
if node['fqdn'] == 'c4t12189.itcs.hpecorp.net'
    ...
    default[:propel_nginx][:propel_applayer_vip] = nil
...
if node.chef_environment == 'env1'
	...
	default[:propel_nginx][:propel_applayer_vip] = "pln-cd1-apigw-vip.core.eslabs.ssn.hp.com"
